...
<button href='https://calliope.cc/media/pages/start/tipps/96fe22d2a5-1602240640/jlink_ob_calliope_mini.hex' >Download Bootloader</button>


Falls ihr Windows 7 benutzt, empfehlen wir folgende Version und die zusätzliche *selectr*-Datei: 
<button href='https://calliope.cc/media/pages/start/tipps/1f01bf3129-1604570158/kl26z_calliope_if_crc.hex' >Download Bootloader Windows 7</button>

<button href='https://calliope.cc/media/pages/start/tipps/1f01bf3129-1604570158/kl26z_calliope_if_crc.hex' >Download selectr Windows 7</button>
